                            ...
                            with st.spinner("Đang chấm điểm Task 2..."):
                                ...
                                * **BAND 9 (Expert):**
                                ...
                                {{
                                    "TA": int, "CC": int, "LR": int, "GRA": int,
                                    "Overall": float,
                                    "Feedback": "### Đánh giá tổng quan\\n[1-2 câu nhận xét mức độ hoàn thành bài, điểm mạnh và điểm yếu cốt lõi]\\n\\n### Phân tích chi tiết từng tiêu chí\\n\\n**1. Task Response (TR)**\\n* **✔️ Điểm tốt:** [Chỉ ra 1 điểm tốt]\\n* **❌ Lỗi tư duy/Lập luận:** [Chỉ ra chính xác chỗ nào thiếu logic, lạc đề, ví dụ yếu hoặc ý chưa phát triển sâu. BẮT BUỘC trích dẫn câu của học viên để minh họa]\\n* **💡 Gợi ý nâng cấp:** [Hướng dẫn cách phát triển ý sâu sắc hơn theo mô hình PEER, hoặc gợi ý ví dụ sắc bén hơn]\\n\\n**2. Coherence & Cohesion (CC)**\\n* **❌ Lỗi liên kết:** [Chỉ ra cụ thể đoạn nào dùng sai từ nối, lạm dụng từ nối, hoặc nhảy ý thiếu mượt mà]\\n* **💡 Sửa lỗi:** [Trích câu gốc] ➡️ [Viết lại mạch lạc, uyển chuyển hơn]\\n\\n**3. Lexical Resource (LR)**\\n* **✨ Ít nhất 3 Cụm từ cần nâng cấp (BẮT BUỘC TRÍCH TỪ BÀI HỌC VIÊN):**\\n  1. *Gốc (Kém/Sai):* '...' ➡️ *Nâng cấp (Band 7/8+):* '...' (Giải thích: ...)\\n  2. *Gốc (Kém/Sai):* '...' ➡️ *Nâng cấp (Band 7/8+):* '...' (Giải thích: ...)\\n  3. *Gốc (Kém/Sai):* '...' ➡️ *Nâng cấp (Band 7/8+):* '...' (Giải thích: ...)\\n\\n**4. Grammatical Range & Accuracy (GRA)**\\n* **🛠️ Chữa ít nhất 3 lỗi ngữ pháp nặng hoặc câu đơn điệu nhất (BẮT BUỘC TRÍCH TỪ BÀI HỌC VIÊN):**\\n  1. *Sai/Đơn điệu:* '...' ➡️ *Sửa/Nâng cấp thành câu phức:* '...' (Lý do: ...)\\n  2. *Sai/Đơn điệu:* '...' ➡️ *Sửa/Nâng cấp thành câu phức:* '...' (Lý do: ...)\\n  3. *Sai/Đơn điệu:* '...' ➡️ *Sửa/Nâng cấp thành câu phức:* '...' (Lý do: ...)"
                                }}
                                """
