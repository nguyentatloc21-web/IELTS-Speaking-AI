                        ...
                        * **Better (Thầy Lộc gợi ý):** "[Viết lại câu đó hay hơn, chuẩn native hơn]"
                        ...
                        try:
                            ...
                            if resp.status_code == 200:
                                ...
                                st.error("⚠️ Máy chủ đang bận. Vui lòng thử lại sau.")
                ...
                if st.button("✨ Tạo Bài Tập Trắc Nghiệm Mới"):
                    with st.spinner("AI đang phân tích bài đọc và tạo câu hỏi..."):
                        ...
                        if json_str:
                            ...
                            st.warning("⚠️ Máy chủ Google đang quá tải. Thầy Lộc nhờ bạn chờ 1 phút rồi bấm lại nút này nhé!")
        ...
        if st.button("🔍 Tìm Kênh/Podcast Phù Hợp"):
            with st.spinner("Đang tìm kiếm nguồn nghe chất lượng..."):
                ...
                if result:
                    ...
                    st.warning("⚠️ Máy chủ đang bận. Bạn vui lòng tải lại trang hoặc bấm tìm kiếm lại 2-3 lần nhé!")
            ...
            if script_input:
                with st.spinner("AI đang phân tích..."):
                    ...
                    if result:
                        ...
                        st.warning("⚠️ Máy chủ đang bận. Bạn vui lòng bấm nút lại lần nữa nhé!")
            else:
